  ...
  return (
    <StaffHeader currentUser={currentUser} userRole={userRole} onLogout={handleLogout}>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">จัดการข้อมูลคนไข้ (Staff)</h1>
          <p className="text-gray-500 mt-1">จัดการฐานข้อมูลคนไข้สำหรับเจ้าหน้าที่</p>
        </div>
                  ...
                  <tr key={patient.id} className="hover:bg-emerald-50/40 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          disabled
                          className="p-2 rounded-lg text-gray-300 cursor-not-allowed opacity-50"
                          title="เฉพาะ Admin ที่สามารถลบได้"
                        >
                          <IconTrash />
                        </button>
                      </div>
